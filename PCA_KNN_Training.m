...
%% Training KNN Classifier using PCA reduced training images
%   For KNN we agreed to use 1, 3, 5 and 10 for nearest neighbour

PCA_KNN_Classifier = fitcknn(Xpca_train, trainLabels,'NumNeighbors',1);
...
predictedLabels = predict(PCA_KNN_Classifier, Xpca_test);

%% Accuracy

PCA_KNN_Accuracy = (sum(predictedLabels == testLabels)/numel(testLabels))*100
...
save PCA_KNN_Classifier PCA_KNN_Classifier
