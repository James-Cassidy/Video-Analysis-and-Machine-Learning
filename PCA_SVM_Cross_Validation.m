...
PCA_SVM_CV_Classifier = fitcecoc(trainingFeatures, trainingLabels,'KFold', 5, 'Learners', t);
...
predictedLabels = kfoldPredict(PCA_SVM_CV_Classifier);

cvTrainError = kfoldLoss(PCA_SVM_CV_Classifier);

% Accuracy of 5 fold Cross Validation
cvTrainAccuracy = 1 - cvTrainError;

%% Cross Validation Error and Accuracy in percentage
CV_PCA_SVM_Accuracy = cvTrainAccuracy*100

CV_PCA_SVM_ErrorRate = cvTrainError*100
...
save PCA_SVM_CV_Classifier PCA_SVM_CV_Classifier
