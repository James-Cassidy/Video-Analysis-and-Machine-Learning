...
Full_Image_SVM_Classifier = fitcecoc(trainingImages, trainingLabels,'Learners', t);
...
predictedLabels = predict(Full_Image_SVM_Classifier, testingImages);
...
SVMAccuracy = (sum(predictedLabels == testingLabels)/numel(testingLabels))*100
...
save Full_Image_SVM_Classifier Full_Image_SVM_Classifier